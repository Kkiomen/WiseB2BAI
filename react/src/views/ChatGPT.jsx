...
import ChatMessages from "../components/utils/ChatMessages.jsx";
import {useCookies} from "react-cookie";


export default function ChatGPT({navigation}) {
    ...
    <div className="mx-0 h-screen">
      <div className="w-full relative bg-ai-conversation-page flex flex-col justify-between h-screen">
        ...
        <div className="overflow-y-auto" id="chatBox" ref={chatRef}>
          <ChatMessages messages={messages} regenerate={regenerateResponse} />
        </div>
        <div className="px-6 pt-5 border-t border-ai-conversation-border mb-5">
